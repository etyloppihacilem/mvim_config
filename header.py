...
def gen_header(filename, comment):
    ...
    """
    HEX = "646f75627420796f7572206f776e206578697374656e6365"
    WHALE = [
        '       """  ',
        "-\\-    _|__",
        " |\\___/  . \\",
    ...
    ret = []
    comment_width = (WIDTH - (1 + len(comment[0]))) - len(HEX)
    fill = comment_width // 2
    ret.append(comment[0] + " " + "#" * fill + HEX + "#" * (fill + comment_width % 2))
    if len(comment) == 1:
